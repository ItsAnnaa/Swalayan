...
//     $select_cart = mysqli_query($conn, "SELECT * FROM 'cart' where nama_barang = '$namabarang'");

//     if(mysqli_fetch_array($select_cart) > 0){ ?>
<!-- //         <script>
//             alert("Produk Sukses Ditambahkan")
//         </script> -->
<!-- // 
//     }else{
//         $masuk_cart = mysqli_query($conn,"INSERT INTO 'cart'(nama_barang,harga_jual,gambar)
//         VALUES ($namabarang, $hargajual, $gambar)");
//     }
                ...
                <div class="sidebar-item-container d-flex flex-column justify-content-center align-items-center">
                    ...
                    <a href="#" class="sidebar-item" onclick="toggleActive(this)">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M9.09003 8.99996C9.32513 8.33163 9.78918 7.76807 10.4 7.40909C11.0108 7.05012 11.7289 6.9189 12.4272 7.03867C13.1255 7.15844 13.7588 7.52148 14.2151 8.06349C14.6714 8.60549 14.9211 9.29148 14.92 9.99996C14.92 12 11.92 13 11.92 13" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </a>
                ...
                <div class="d-flex justify-content-between align-items-center w-100 mb-3 mb-md-0">
                    <div class="d-flex justify-content-start align-items-start">
                        ...
                        <div class="d-none d-sm-flex flex-column justify-content-start align-items-start">
                            <h2 class="nav-title">Hy,Mau Belanja Apa?  </h2>
                            <h5 class="nav-desc">10/12/2022</h5>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <button class="nav-btn cart">
                            <img src="../assets/img/global/navbar/shopping-cart.svg" alt="" href="cart.php">
                        </button>
                    </div>
                </div>
                            ...
                            while ($row = $result->fetch_assoc()) : ?>
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="food-card d-flex justify-content-center align-items-center flex-column">
                                        <div class="food-img" style="border-radius: 90px;">
                                        ...
                                        <button class="food-btn" name="add_to_cart" value="add_to_cart">Add to Cart</button>
                                    </div>
                                </div>
                            <?php endwhile; ?>
                        </div>
